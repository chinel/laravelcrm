        ...
        <div class="container">
            ...
            <div class="row  m-t-15 clearfix">
                ...
                <div class="col-sm-12 col-md-6 col-lg-6">
                    <h4 class="page-title">Deals Reports</h4>
                </div>

                <div class="col-sm-12 col-md-6 col-lg-6" style="text-align: right;">
                    <div class="">
                        <div class=" m-t-15">
                            <form class="form-inline" action="{{url('/Admin/SearchDealChart')}}" method="post" data-parsley-validate novalidate>
                                <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                                <select class="form-control m-b-5" name="stage" required parsley-trigger="change">
                                    <option value="">Search by deal stage</option>
