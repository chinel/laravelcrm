                 ...
                 <div class="row">
                     ...
                     <div class="col-lg-3 col-md-6">
                         <div class="card-box">
                             ...
                             <h4 class="header-title m-t-0 m-b-30">Pending Task</h4>

                             <div class="widget-box-2">
                                 <div class="widget-detail-2">
                                     <span class="badge badge-warning pull-left m-t-20"> <i
                                             class="zmdi zmdi-trending-up"></i> </span>
                                     <h2 class="m-b-0"> {{count($pendingTasks)}} </h2>
                                     <p class="text-muted m-b-25">Total No.</p>
                                 </div>
                     ...
                     <div class="col-lg-3 col-md-6">
                         <div class="card-box">
                             ...
                             <h4 class="header-title m-t-0 m-b-30">Completed Task</h4>

                             <div class="widget-box-2">
                                 <div class="widget-detail-2">
                                     <span class="badge badge-info pull-left m-t-20"> <i
                                             class="zmdi zmdi-trending-up"></i> </span>
                                     <h2 class="m-b-0"> {{count($completedTasks)}} </h2>
                                     <p class="text-muted m-b-25">Total No.</p>
                                 </div>
