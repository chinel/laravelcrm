    ...
    <!-- Page-Title -->
        ...
        <div class="row">
            ...
            <div class="col-sm-8" style="background-color: #FFFFFF;">
                ...
                <h4 class="custom-modal-title">Send Mail to {{$contact->name}}</h4>
                <div class="custom-modal-text text-left">
                    <form role="form" method="post" action="{{url('Staff/sendMailContact')}}" data-parsley-validate novalidate>
                        <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                        <div class="form-group">
                            <label for="name">Subject</label>
                            <input type="text" class="form-control" id="name" required  name="subject" parsley-trigger="change">
                        </div>

                        <div class="form-group">
                            <label for="company">Message</label>
                            <textarea class="form-control" name="message" required parsley-trigger="change"></textarea>
                        </div>
