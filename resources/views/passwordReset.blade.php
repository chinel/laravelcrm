...
<div class="wrapper-page">
    ...
    <div class="m-t-40 card-box">
        ...
        <div class="panel-body">
            <form class="form-horizontal m-t-20" action="{{url('/updatePassword')}}" data-parsley-validate novalidate method="post">
                <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                <div class="form-group ">
                    <div class="col-xs-12">
                        <input class="form-control" type="password" required placeholder="Enter new password" parsley-trigger="change" id="pass1" name="password">
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-xs-12">
                        <input class="form-control" type="password" required placeholder="Confirm new password" parsley-trigger="change" data-parsley-equalto="#pass1" id="password2">
                    </div>
                </div>
